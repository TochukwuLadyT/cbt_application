 ...
 * @author LADYT
 */
public class end_exam_success extends javax.swing.JFrame {
 
    Date date = new Date(); 
    DefaultTableModel model = new DefaultTableModel();
    String contain;
    Dimension myscreen = Toolkit.getDefaultToolkit().getScreenSize();
    Thread th; int a=0, b=0, c=0;
    ...
    public end_exam_success() {
     ...
     public end_exam_success(String marks) { 
        initComponents();
        String marks1= "YOUR SCORE IS : " +marks;
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("DEAR CANDIDATE,\n\nEXAMINATION IS SUCCESSFULLY SUBMITTED\n\nQUIETLY LEAVE THE EXAM HALL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(end_exam_success.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new end_exam_success().setVisible(true);
            }
        });
    }
